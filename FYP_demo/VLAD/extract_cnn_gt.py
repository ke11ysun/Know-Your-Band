...
parser.add_option("--config", dest="config_filename", help="Location to read the metadata related to the training (generated when training).", default="config5.pickle")
parser.add_option("--model_path", dest="model_path")
