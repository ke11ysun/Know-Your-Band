...
ap.add_argument("-r", "--retrieve", help = "number of images to retrieve", default='10')
...
img_path = "/users/sunjingxuan/desktop/matchalbum"
pathVD = "/users/sunjingxuan/pycharmprojects/VLAD/vd_discogshot_cpu3.pickle"
treeIndex = "/users/sunjingxuan/pycharmprojects/VLAD/tree_vlad_hot_cpu3.pickle"
