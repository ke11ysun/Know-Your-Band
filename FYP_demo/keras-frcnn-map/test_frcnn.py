...
parser.add_option("--config_filename", dest="config_filename", default="/users/sunjingxuan/desktop/retrain_models/retrain_config_init.pickle")
parser.add_option("--network", dest="network", default='resnet50')
parser.add_option("--model_path", dest="model_path", default="/users/sunjingxuan/desktop/retrain_models/retrain_model_init.hdf5")
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
    ...
    for jk in range(R.shape[0]//C.num_rois + 1):
        ...
        # # print(all_roifs.shape)  (1, 32, 14, 14, 1024)

        # [all_scenefs, P_cls, P_regr] = model_classifier_only.predict([F, ROIs])
        # # print(P_cls.shape)  (1, 32, 3)
        ...
        for ii in range(P_cls.shape[1]):
            ...
            # print(all_roifs[0, ii, :].shape)  (14, 14, 1024)
            ...
            # print(roifs[cls_name][0].shape)

    # print('album')
    # print(roifs['album'][0].shape)
    # print('logo')
    # print(roifs['logo'][0].shape)
    ...
    for key in bboxes:
        ...
        for jk in range(new_boxes.shape[0]):
            ...
            # cropped = img[real_y1:real_y2, real_x1:real_x2]
            # cv2.imwrite("cropped" + str(jk) + ".jpg", cropped)
    ...
    #     cropname = img_name + "_cropped" + str(i) + ".jpg"
    ...
    cv2.imshow('img', img)
    cv2.waitKey(0)
    cv2.imwrite('/users/sunjingxuan/desktop/demo_qimg/_imshow_demo/{}.png'.format(img_name),img)
